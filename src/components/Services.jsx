...
const Services = () => {
  const services = [
    {
      ...
      description: 'Chaque caftan est nettoyé et repassé avant et après location.',
    },
    {
      icon: <MapPin size={24} />,
  ...
  const stats = [
    ...
    { icon: <Award size={20} />, value: '60€', label: 'Prix unique location' },
  ]
      ...
      <div className="container-custom">
        ...
        >
          {stats.map((stat, index) => (
            <div key={index} className="text-center py-6 px-4 rounded-2xl bg-brand-ivory">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-brand-ink rounded-2xl md:rounded-3xl p-8 md:p-14 text-center"
        >
